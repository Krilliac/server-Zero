...
class WorldSession
{
    ...
    public:
        ...
        // Anti-Cheat time-sync: rolling latency window + EWMA fed from CMSG_PING.
        // Used by movement detectors for latency-aware tolerances and desync checks.
    ...
    private:
        ...
        uint32 m_latency;
        // Anti-Cheat time-sync: rolling latency window + smoothed value.
        ...
        uint32 m_latMin;
        uint32 m_latMax;
        // Desync detection: flagged on the network thread (HandlePing), consumed
        // on the safe map/world thread in WorldSession::Update.
