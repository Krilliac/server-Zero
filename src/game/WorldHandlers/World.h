...
enum eConfigUInt32Values
{
    ...
    // Anti-Cheat debug visualizer (Slice 2)
    CONFIG_UINT32_ACDBG_DESPAWN,
    CONFIG_UINT32_ACDBG_TRACE_MINDIST,
    CONFIG_UINT32_ACDBG_GO_MOVEMENT,
    CONFIG_UINT32_ACDBG_GO_TIMESYNC,
    CONFIG_UINT32_ACDBG_GO_SPEED,
    CONFIG_UINT32_ACDBG_GO_TELEPORT,
    ...
    // Cluster anti-cheat Phase 4: migration seam state-consistency validation
    CONFIG_UINT32_ANTICHEAT_MIGRATION_SPEED_TOL,
    CONFIG_UINT32_ANTICHEAT_MIGRATION_MAX_ELAPSED,
    // Cluster anti-cheat Phase 6: per-violation-type autoban kick weighting (percent)
    CONFIG_UINT32_AC_AUTOBAN_WEIGHT_TELEPORT,
    CONFIG_UINT32_AC_AUTOBAN_WEIGHT_FLY,
    CONFIG_UINT32_AC_AUTOBAN_WEIGHT_SPEED,
    CONFIG_UINT32_AC_AUTOBAN_WEIGHT_PROTOCOL,
    CONFIG_UINT32_CLUSTER_NODE_ID,
    CONFIG_UINT32_CLUSTER_PORT,
    CONFIG_UINT32_CLUSTER_PEER_PORT,
    CONFIG_UINT32_CLUSTER_HEARTBEAT,
    CONFIG_UINT32_CLUSTER_VISUAL_INTERVAL,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_ACDBG_ENABLE,
    CONFIG_BOOL_ACDBG_TRACE,
    ...
    // Cluster anti-cheat Phase 5: optional movement-hack checks (both OFF by default)
    CONFIG_BOOL_ANTICHEAT_NOCLIP_STRICT,
    CONFIG_BOOL_ANTICHEAT_KNOCKBACK_CHECK,
    // Cluster anti-cheat Phase 4: migration seam state-consistency master gate
    CONFIG_BOOL_ANTICHEAT_MIGRATION_VALIDATE,
    // Cluster anti-cheat Phase 6: autoban GM-exempt + ban-evasion IP flagging
    CONFIG_BOOL_AC_AUTOBAN_GM_EXEMPT,
    CONFIG_BOOL_AC_AUTOBAN_EVASION_FLAG,
    CONFIG_BOOL_MOVEMENT_SMOOTHING,
    CONFIG_BOOL_CLUSTER_ENABLE,
    CONFIG_BOOL_CLUSTER_MIGRATION,
    CONFIG_BOOL_CLUSTER_AUTOMIGRATE,
    CONFIG_BOOL_CLUSTER_VISUAL,
    CONFIG_BOOL_CLUSTER_CHATTAG,
    CONFIG_BOOL_CLUSTER_CROSSNODE_BG,
    CONFIG_BOOL_GATEWAY_SEAMLESS,
